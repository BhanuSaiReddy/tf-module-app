...
resource "aws_lb_listener_rule" "main" {
  ...
  condition {
    host_header {
      values = [var.component == "frontend" ? "${var.env}.devopsbs344.online" : "${var.component}-${var.env}.devopsbs344.online"]
    }
  }
}
    ...
    "Statement" : [
      {
        ...
        "Resource" : "arn:aws:ssm:us-east-1:835279655416:parameter/docdb.${var.env}.*"
      },
      {
        "Sid" : "VisualEditor1",
        "Effect" : "Allow",
